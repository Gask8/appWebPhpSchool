...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
          ...
          if($_SESSION['uid']==1){
            echo "<li class='dropdown'>
              ...
              <ul class='dropdown-menu'>
                ...
                <li><a href='/desarolloWeb/php/admin/add.php'>Add Item</a></li>
              </ul>
              </li>";
          }
        }
    ...
    <ul class="nav navbar-nav navbar-right">
      <?php
        if( !isset($_SESSION['nombre']) ){
          echo "<li><a href='/desarolloWeb/php/signUp.php'><span class='glyphicon glyphicon-user'></span> Sign Up</a></li>
        ...
        <li><button class='btn btn-success navButton'><span class='glyphicon glyphicon-log-in'></span> Login</button></li>
          ...
          echo "<li><a href='/desarolloWeb/php/user.php'><span class='glyphicon glyphicon-user'></span> Hola, " . $_SESSION['nombre'] . "</a></li>
